...
@dso_cache = dso_local local_unnamed_addr global [690 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 21928018, ; hash 0x14e9852, from name: Project
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 306340669, ; hash 0x1242633d, from name: aot-Project.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Project.dll.so
		ptr null; void* handle (0x0)
	}, ; 48
	...
	%struct.DSOCacheEntry {
		i64 754566565, ; hash 0x2cf9c5a5, from name: libaot-Project.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Project.dll.so
		ptr null; void* handle (0x0)
	}, ; 109
	...
	%struct.DSOCacheEntry {
		i64 846100344, ; hash 0x326e7778, from name: libaot-Project
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Project.dll.so
		ptr null; void* handle (0x0)
	}, ; 127
	...
	%struct.DSOCacheEntry {
		i64 1944177242, ; hash 0x73e1ca5a, from name: Project.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Project.dll.so
		ptr null; void* handle (0x0)
	}, ; 303
	...
	%struct.DSOCacheEntry {
		i64 3751482361, ; hash 0xdf9b13f9, from name: aot-Project
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Project.dll.so
		ptr null; void* handle (0x0)
	}, ; 608
