...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 690, ; uint32_t number_of_dso_cache_entries (0x2b2)
	i32 33555266, ; uint32_t android_runtime_jnienv_class_token (0x2000342)
	i32 100672124, ; uint32_t jnienv_initialize_method_token (0x600227c)
	i32 100672123, ; uint32_t jnienv_registerjninatives_method_token (0x600227b)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [690 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.27_name, ; name: libaot-Syncfusion.Maui.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 36
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.34_name, ; name: libaot-Xamarin.AndroidX.Browser.dll.so
		ptr null; void* handle (0x0)
	}, ; 63
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Camera.MAUI.dll.so
		ptr null; void* handle (0x0)
	}, ; 87
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4614033500520400916, ; hash 0x40085705c4454814, from name: libaot-Project
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Project.dll.so
		ptr null; void* handle (0x0)
	}, ; 155
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.28_name, ; name: libaot-Syncfusion.Maui.DataSource.dll.so
		ptr null; void* handle (0x0)
	}, ; 158
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.29_name, ; name: libaot-Syncfusion.Maui.GridCommon.dll.so
		ptr null; void* handle (0x0)
	}, ; 231
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 8203160352733448076, ; hash 0x71d77ae0ec3ec78c, from name: Project.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Project.dll.so
		ptr null; void* handle (0x0)
	}, ; 280
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.30_name, ; name: libaot-Syncfusion.Maui.ListView.dll.so
		ptr null; void* handle (0x0)
	}, ; 290
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 10602089081963619916, ; hash 0x93222fd9077d264c, from name: aot-Project.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Project.dll.so
		ptr null; void* handle (0x0)
	}, ; 389
	...
	%struct.DSOCacheEntry {
		i64 12634831966142587901, ; hash 0xaf57f0bb22ade3fd, from name: Project
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Project.dll.so
		ptr null; void* handle (0x0)
	}, ; 468
	...
	%struct.DSOCacheEntry {
		i64 17051974653109028527, ; hash 0xeca4c89a0d8746af, from name: aot-Project
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Project.dll.so
		ptr null; void* handle (0x0)
	}, ; 633
	...
	%struct.DSOCacheEntry {
		i64 17565749281764008066, ; hash 0xf3c613e7891de082, from name: libaot-Project.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Project.dll.so
		ptr null; void* handle (0x0)
	}, ; 647
...
@.env.3 = private unnamed_addr constant [37 x i8] c"30d01637-3760-47ff-a3f4-6da1155604d9\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [22 x i8] c"libaot-Project.dll.so\00", align 16
@.DSOCacheEntry.8_name = private unnamed_addr constant [26 x i8] c"libaot-Camera.MAUI.dll.so\00", align 16
...
@.DSOCacheEntry.27_name = private unnamed_addr constant [35 x i8] c"libaot-Syncfusion.Maui.Core.dll.so\00", align 16
@.DSOCacheEntry.28_name = private unnamed_addr constant [41 x i8] c"libaot-Syncfusion.Maui.DataSource.dll.so\00", align 16
@.DSOCacheEntry.29_name = private unnamed_addr constant [41 x i8] c"libaot-Syncfusion.Maui.GridCommon.dll.so\00", align 16
@.DSOCacheEntry.30_name = private unnamed_addr constant [39 x i8] c"libaot-Syncfusion.Maui.ListView.dll.so\00", align 16
...
@.DSOCacheEntry.34_name = private unnamed_addr constant [39 x i8] c"libaot-Xamarin.AndroidX.Browser.dll.so\00", align 16
