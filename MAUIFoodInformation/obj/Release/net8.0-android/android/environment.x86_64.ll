...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 580, ; uint32_t number_of_dso_cache_entries (0x244)
	i32 33555182, ; uint32_t android_runtime_jnienv_class_token (0x20002ee)
	i32 100671086, ; uint32_t jnienv_initialize_method_token (0x6001e6e)
	i32 100671085, ; uint32_t jnienv_registerjninatives_method_token (0x6001e6d)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [580 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1335854284852461254, ; hash 0x1289e864f8507ec6, from name: libaot-MAUIFoodInformation
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MAUIFoodInformation.dll.so
		ptr null; void* handle (0x0)
	}, ; 35
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.29_name, ; name: libaot-Xamarin.AndroidX.Camera.Camera2.dll.so
		ptr null; void* handle (0x0)
	}, ; 53
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Camera.MAUI.dll.so
		ptr null; void* handle (0x0)
	}, ; 79
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4028572431138606148, ; hash 0x37e85d4825f2cc44, from name: aot-MAUIFoodInformation
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MAUIFoodInformation.dll.so
		ptr null; void* handle (0x0)
	}, ; 121
	...
	%struct.DSOCacheEntry {
		i64 5263185576092276657, ; hash 0x490a976559f097b1, from name: MAUIFoodInformation.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MAUIFoodInformation.dll.so
		ptr null; void* handle (0x0)
	}, ; 147
	...
	%struct.DSOCacheEntry {
		i64 5843137965229205699, ; hash 0x5116ff056715e8c3, from name: libaot-MAUIFoodInformation.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MAUIFoodInformation.dll.so
		ptr null; void* handle (0x0)
	}, ; 159
	...
	%struct.DSOCacheEntry {
		i64 9060364666071734585, ; hash 0x7dbce1a8f0b4d939, from name: aot-MAUIFoodInformation.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MAUIFoodInformation.dll.so
		ptr null; void* handle (0x0)
	}, ; 277
	...
	%struct.DSOCacheEntry {
		i64 10216577660438441461, ; hash 0x8dc893409e9fedf5, from name: MAUIFoodInformation
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MAUIFoodInformation.dll.so
		ptr null; void* handle (0x0)
	}, ; 311
...
@.env.3 = private unnamed_addr constant [37 x i8] c"a0f2183f-882f-4868-b9c9-dbdc6ef196ea\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [36 x i8] c"com.companyname.mauifoodinformation\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [34 x i8] c"libaot-MAUIFoodInformation.dll.so\00", align 16
@.DSOCacheEntry.9_name = private unnamed_addr constant [26 x i8] c"libaot-Camera.MAUI.dll.so\00", align 16
...
@.DSOCacheEntry.29_name = private unnamed_addr constant [46 x i8] c"libaot-Xamarin.AndroidX.Camera.Camera2.dll.so\00", align 16
