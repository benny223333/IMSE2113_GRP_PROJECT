...
@dso_cache = dso_local local_unnamed_addr global [580 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 62495675, ; hash 0x3b99bbb, from name: MAUIFoodInformation.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1568858013, ; hash 0x5d82df9d, from name: aot-MAUIFoodInformation.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MAUIFoodInformation.dll.so
		ptr null; void* handle (0x0)
	}, ; 202
	...
	%struct.DSOCacheEntry {
		i64 1789985609, ; hash 0x6ab10349, from name: libaot-MAUIFoodInformation.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MAUIFoodInformation.dll.so
		ptr null; void* handle (0x0)
	}, ; 230
	...
	%struct.DSOCacheEntry {
		i64 1954954969, ; hash 0x74863ed9, from name: aot-MAUIFoodInformation
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MAUIFoodInformation.dll.so
		ptr null; void* handle (0x0)
	}, ; 254
	...
	%struct.DSOCacheEntry {
		i64 2778623642, ; hash 0xa59e6e9a, from name: libaot-MAUIFoodInformation
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MAUIFoodInformation.dll.so
		ptr null; void* handle (0x0)
	}, ; 376
	...
	%struct.DSOCacheEntry {
		i64 3026793313, ; hash 0xb4693361, from name: MAUIFoodInformation
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MAUIFoodInformation.dll.so
		ptr null; void* handle (0x0)
	}, ; 420
